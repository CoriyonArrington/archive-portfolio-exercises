...
export function ProjectCard({ project, priority = false }: ProjectCardProps) {
  ...
  return (
    <>
      <div className="rounded-lg overflow-hidden flex flex-col h-full border border-gray-200 dark:border-gray-800 bg-white dark:bg-black transition-all duration-300 hover:shadow-lg">
