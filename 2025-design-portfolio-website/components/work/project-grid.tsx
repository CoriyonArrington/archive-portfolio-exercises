...
function ProjectListItem({ project }: { project: Project }) {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row gap-6 border border-gray-200 dark:border-gray-800 bg-white dark:bg-black rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300">
        {/* Image section */}
