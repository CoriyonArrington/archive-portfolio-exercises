        ...
        <div className="space-y-8">
          {processData.map((step, index) => {
            ...
            return (
              <div
                key={step.id}
                className="border border-gray-200 dark:border-gray-800 rounded-lg p-8 bg-white dark:bg-black transition-all duration-300 hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-700"
              >
