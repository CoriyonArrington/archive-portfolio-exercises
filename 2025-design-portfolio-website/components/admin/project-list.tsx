...
import { nuclearRevalidation, triggerDeploy } from "@/app/actions/revalidation"
...
export function ProjectList() {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      // Use server actions for revalidation
      try {
        // Nuclear revalidation
        await nuclearRevalidation()

        // Trigger deploy
        const deployResult = await triggerDeploy()

        if (!deployResult.success) {
          console.error("Deploy failed:", deployResult.message)
