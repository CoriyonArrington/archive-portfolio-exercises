...
--
-- Name: feedback_submissions feedback_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: quizzes quizzes_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: blog Admin full access - blog; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin full access - blog" ON public.blog USING ((auth.role() = 'admin'::text));


--
-- Name: faqs Admin full access - faqs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin full access - faqs" ON public.faqs USING ((auth.role() = 'admin'::text));


--
-- Name: pages Admin full access - pages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin full access - pages" ON public.pages USING ((auth.role() = 'admin'::text));


--
-- Name: process_phases Admin full access - process_phases; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin full access - process_phases" ON public.process_phases USING ((auth.role() = 'admin'::text));


--
-- Name: services Admin full access - services; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin full access - services" ON public.services USING ((auth.role() = 'admin'::text));


--
-- Name: testimonials Admin full access - testimonials; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin full access - testimonials" ON public.testimonials USING ((auth.role() = 'admin'::text));


--
-- Name: contact_submissions Admin read - contact_submissions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin read - contact_submissions" ON public.contact_submissions FOR SELECT USING ((auth.role() = 'admin'::text));


--
-- Name: feedback_submissions Admin read - feedback; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin read - feedback" ON public.feedback_submissions FOR SELECT USING ((auth.role() = 'admin'::text));


--
-- Name: contact_submissions Allow insert - contact_submissions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: feedback_submissions Allow insert - feedback; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow insert - feedback" ON public.feedback_submissions FOR INSERT WITH CHECK (true);


--
-- Name: projects Allow select on featured projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow select on featured projects" ON public.projects FOR SELECT USING ((featured = true));


--
-- Name: options Authenticated read/write - options; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Authenticated read/write - options" ON public.options USING (((auth.role() = 'authenticated'::text) OR (auth.role() = 'admin'::text)));


--
-- Name: questions Authenticated read/write - questions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Authenticated read/write - questions" ON public.questions USING (((auth.role() = 'authenticated'::text) OR (auth.role() = 'admin'::text)));


--
-- Name: quizzes Authenticated read/write - quizzes; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Authenticated read/write - quizzes" ON public.quizzes USING (((auth.role() = 'authenticated'::text) OR (auth.role() = 'admin'::text)));


--
-- Name: contact_submissions Block spam submissions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Block spam submissions" ON public.contact_submissions FOR INSERT TO authenticated, anon WITH CHECK ((honeypot IS NULL));


--
-- Name: blog Public read - blog; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: faqs Public read - faqs; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pages Public read - pages; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: process_phases Public read - process_phases; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Public read - process_phases" ON public.process_phases FOR SELECT USING (true);
...
--
-- Name: blog; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: projects delete_project_policy; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY delete_project_policy ON public.projects FOR DELETE USING ((auth.uid() IS NOT NULL));
...
--
-- Name: projects insert_project_policy; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY insert_project_policy ON public.projects FOR INSERT WITH CHECK ((auth.uid() IS NOT NULL));
...
--
-- Name: problems problems_select_policy; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: projects select_project_policy; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY select_project_policy ON public.projects FOR SELECT USING ((auth.uid() IS NOT NULL));
...
--
-- Name: solutions solutions_select_policy; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY solutions_select_policy ON public.solutions FOR SELECT USING (true);
...
--
-- Name: projects update_project_policy; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY update_project_policy ON public.projects FOR UPDATE USING ((auth.uid() IS NOT NULL));
